...
extension BuildContextExtension on BuildContext {
  ...
  double get heightt => MediaQuery.of(this).size.height;
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8.0),
              Text('width: ${context.widthh}'),
              Text('height: ${context.heightt}'),
              Container(
                height: 50.0,
                width: context.widthh,
                ...
                child: Text('Gradient and height: ${context.heightt}'),
              ),
              const SizedBox(height: 8.0),
              Container(
                height: 50.0,
                ...
                child: Text('Gradient and width: ${context.widthh}'),
              ),
              const SizedBox(height: 8.0),
            ],
          ),
